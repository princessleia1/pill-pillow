  ...
  VTList.delegate = {
    ...
    configureTile: function(tile, info) {
      if (info.type == "colour-pool") {
        ...
        titletext_1.style.fill =
          checkedState[info.index] === 0
            ? colorSchemes[colorSchemeName].unchecked
            : colorSchemes[colorSchemeName].checked;
...
try {
  ...
  if (
    storedListState.listData !== undefined &&
    storedListState.listData.length !== 0
  ) {
